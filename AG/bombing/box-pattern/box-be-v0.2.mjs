...
export { calculateBoxClimbSemCompositionV0_3 } from "./box-sem-composition-v0.3.mjs";
export { calculateBoxPatternReentryV0_3 } from "./pattern-reentry-v0.3.mjs";

export const BOX_BE_ENTRYPOINT_V0_2 = Object.freeze({
  status: "Work / Pure Calculation / Not Official",
  entrypointVersion: "0.2.0",
  fixedAngleOffDeg: 90,
